<%@ Page Title="" Language="C#" MasterPageFile="~/Partner/Page.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="WebSite.Partner.Profile" %>
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            <input id="id" class="form-control form-data" type="hidden" value="<%= UserData.id %>" />
                            <% List<Entities.zUsers> dList = Bll.zUsers.Select(UserData.id, filter: "");
                                ...
                                <div class="form-group">
                                    <label><%= Language.GetPartner("Sifre") %></label>
