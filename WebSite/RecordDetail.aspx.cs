...
namespace WebSite
{
    public partial class RecordDetail : System.Web.UI.Page
    {
        ...
        {
            photoList = Bll.GeneralPhotos.Select(0, filter: " AND TypeID=0 AND LangID in(0," + Feature.ActiveLanguage + ")  AND CatID=" + RecordID + " AND Approved=1 AND Image<>''", sorting: " Sorting ASC, id DESC ");
