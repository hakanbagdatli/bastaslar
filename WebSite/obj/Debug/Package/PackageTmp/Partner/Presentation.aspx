<%@ Page Title="" Language="C#" MasterPageFile="~/Partner/Page.Master" AutoEventWireup="true" CodeBehind="Presentation.aspx.cs" Inherits="WebSite.Partner.Presentation" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="card-title">
                            <div class="d-block text-muted pt-2 font-size-sm">
                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:;" class="text-muted"><%= Language.GetPartner("Sunumlar") %></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <% var defines = Entities.StaticList.Defines.Where(x => x.CatID == 7);
                        if (UserData.CatID != 1)
