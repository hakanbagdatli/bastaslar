<%@ Page Title="" Language="C#" MasterPageFile="~/Partner/Page.Master" AutoEventWireup="true" CodeBehind="Calendar.aspx.cs" Inherits="WebSite.Partner.Calendar" %>
                                ...
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    <div class="dropdown">
                                        <button class="btn btn-filter-room btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <%= Language.GetPartner("ToplantiOdasiFiltre") %>
                                        </button>
            ...
            return {
                ...
                init: function () {
                    ...
                    var calendar = new FullCalendar.Calendar(calendarEl, {
                        ...
                        isRTL: KTUtil.isRTL(),
                        locale: '<%= SelectedLocale %>', // Dil seçeneği
                        header: {
