<%@ Page Title="" Language="C#" MasterPageFile="~/Raven/Page.Master" AutoEventWireup="true" CodeBehind="Banners.aspx.cs" Inherits="WebSite.Raven.Common.Banners" %>
<%@ Import Namespace="Tools" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pagecontent" runat="server">

    <input id="table" class="form-control" type="hidden" value="14" />
                ...
                <div class="col-md-12">
                    <div class="card card-custom gutter-b example example-compact">
                            ...
                            <table class="table table-separate table-head-custom table-checkable" id="liophinTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 150px;"><%= Language.GetFixed("DilKodu") %></th>
                                ...
                                <tbody>
                                    <% List<Entities.SiteSliders> dList = Bll.SiteSliders.Select(0, filter: "", sorting: " Sorting ASC, id DESC");
                        ...
                        <div class="card-body">
                            ...
                            <% List<Entities.SiteSliders> dList = Bll.SiteSliders.Select(RecordID, filter: ""); %>
                            ...
                            <hr />
                            <div class="form-group">
                                <label><%= Language.GetFixed("LinkBaslik") %></label>
                                <input id="LinkTitle" class="form-control form-data" type="text" value="<%= RecordID > 0 ? dList[0].LinkTitle : "" %>" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label><%= Language.GetFixed("Not") %> 1</label>
                                <input id="Note1" class="form-control form-data" type="text" value="<%= RecordID > 0 ? dList[0].Note1 : "" %>" />
                            </div>
                            <div class="form-group">
                                <label><%= Language.GetFixed("Not") %> 2</label>
                                <input id="Note2" class="form-control form-data" type="text" value="<%= RecordID > 0 ? dList[0].Note2 : "" %>" />
                            </div>
                            <hr />
                            <div class="form-group">
                                <label><%= Language.GetFixed("VideoLink") %></label>
                                <textarea id="VideoLink" class="form-control form-data" rows="4"><%= RecordID > 0 ? dList[0].VideoLink : "" %></textarea>
                            </div>
