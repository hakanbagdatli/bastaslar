<%@ Page Title="" Language="C#" MasterPageFile="~/Raven/Page.Master" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="WebSite.Raven.Translate.Categories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pagecontent" runat="server">
    ...
    <input id="table" class="form-control" type="hidden" value="11" />
                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-body">
                            <table class="table table-separate table-head-custom table-checkable" id="liophinTable">
                                ...
                                <tbody>
                                    <% List<Entities.LangCategories> dList = Bll.LangCategories.Select(0, filter: whereClause);
                                    ...
                                    <tr class="list-data" data-id="<%= item.id %>">
                                        ...
                                        <td>
                                            <a href="?dhx=edit&id=<%= item.id + "&catid=" + item.CatID %>" class="btn btn-sm btn-clean btn-icon" data-toggle='tooltip' data-theme='dark' title="Düzenle">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-body">
                            ...
                            <% List<Entities.LangCategories> dList = Bll.LangCategories.Select(RecordID, filter: ""); %>
                            ...
                            <div class="form-group">
                                ...
                                <input id="MetaUrl" class="form-control form-data" type="text" value="<%= RecordID > 0 ? dList[0].MetaUrl : "" %>" />
                            </div>
                            <div class="form-group">
