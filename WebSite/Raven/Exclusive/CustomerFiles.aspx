<%@ Page Title="" Language="C#" MasterPageFile="~/Raven/Page.Master" AutoEventWireup="true" CodeBehind="CustomerFiles.aspx.cs" Inherits="WebSite.Raven.General.CustomerFiles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pagecontent" runat="server">
    ...
    <input id="table" class="form-control" type="hidden" value="31" />
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            <table class="table table-separate table-head-custom table-checkable" id="liophinTable">
                                ...
                                <tbody>
                                    <% List<Entities.CustomerFiles> dList = Bll.CustomerFiles.Select(0, filter: whereClause,  sorting: " Sorting ASC, id ASC");
                                        ...
                                        <tr class="list-data" data-id="<%= item.id %>">
                                            ...
                                            <td>
                                                <a href="?dhx=edit&id=<%= item.id + "&catid=" + item.CustomerID %>" class="btn btn-sm btn-clean btn-icon mr-2" title="<%= Language.GetFixed("Duzenle") %>"><i class="la la-edit"></i></a>
                        ...
                        <div class="card-body">
                            ...
                            <input id="CustomerID" class="form-control form-data" type="hidden" value="<%= CatID %>" />
                            <% List<Entities.CustomerFiles> dList = Bll.CustomerFiles.Select(RecordID, filter: ""); %>
                            ...
                            <div class="form-group">
                                <table border="0">
                                    <tr>
                                        <td style="width: 175px;"><%=  RecordID > 0 ? Developer.ShowFile(dList[0].Filename) : "" %></td>
                                        <td><%=  RecordID > 0 ? Developer.DeleteFileButton("images", "Image", dList[0].Filename) : "" %></td>
                                    </tr>
                                </table>
                            </div>
                            <% } %>
