...
{
    public partial class AgencyCallbacks : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PageProperties(Language.GetFixed("Aranmalar"), 1);
        }
        //--------------------------------------------------------- pageLoad işlemleri
        ...
        protected void PageProperties(string Title, int MenuID)
        {
            ...
            if (Request["dhx"] != null)
            {
                if (Request["dhx"].ToString() == "edit")
                {
                    ...
                    Breadcrumb.Add(Title, Developer.ConstantUrl("callback") + "?catid=" + CatID);
