<%@ Page Title="" Language="C#" MasterPageFile="~/Raven/Page.Master" AutoEventWireup="true" CodeBehind="Summaries.aspx.cs" Inherits="WebSite.Raven.Inspection.Summaries" %>
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="InspectionID" class="form-control form-data form-data-option" onchange="SelectedChange('InspectionID','GetCustomersbyInspection','CustomerID')">
                                    <%  List<Entities.Inspections> inspectList = Bll.Inspections.Select(0, filter: " AND Approved=1");
                                        foreach (var items in inspectList) { %>
                                    <option value="<%= items.id %>" <%= RecordID > 0 ? dList[0].InspectionID == items.id ? " selected" : "" : "" %>><%= items.InspectionNumber %></option>
                                    <% } %>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="InterestedProjects" class="form-control form-data form-data-option" data-value="<%= RecordID > 0 ? dList[0].InterestedProjects.ToString() : "0" %>">
                                    <option value="0"><%= Language.GetFixed("LutfenSec") %></option>
                                    <% List<Entities.GeneralRecords> projectList = Bll.GeneralRecords.Select(0, filter: " AND CatID in (" + Select.MultipleCategoryID("3") +") AND Approved=1");
                            ...
                            <div class="form-group">
                                <label><%= Language.GetFixed("Durum") %></label>
                                 <select id="Statu" class="form-control form-data form-data-option" data-value="<%= RecordID > 0 ? dList[0].Statu.ToString() : "1" %>">
