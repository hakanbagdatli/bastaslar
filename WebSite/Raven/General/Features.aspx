<%@ Page Title="" Language="C#" MasterPageFile="~/Raven/Page.Master" AutoEventWireup="true" CodeBehind="Features.aspx.cs" Inherits="WebSite.Raven.General.Features" %>
<%@ Import Namespace="Tools" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pagecontent" runat="server">

    <input id="table" class="form-control" type="hidden" value="6" />
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            <table class="table table-separate table-head-custom table-checkable" id="liophinTable">
                                ...
                                <tbody>
                                    <% List<Entities.GeneralFeatures> dList = Bll.GeneralFeatures.Select(0, filter: whereClause,  sorting: " Sorting ASC, id DESC");
                        ...
                        <div class="card-body">
                            ...
                            <% List<Entities.GeneralFeatures> dList = Bll.GeneralFeatures.Select(RecordID, filter: ""); %>
