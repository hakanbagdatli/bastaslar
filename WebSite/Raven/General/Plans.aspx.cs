...
namespace WebSite.Raven.General
{
    public partial class Plans : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PageProperties(Language.GetFixed("Properties"), 4);
        }
        //--------------------------------------------------------- pageLoad işlemleri
        ...
        protected void PageProperties(string Title, int MenuID)
        {
            ...
            if (Request["catid"] != null)
            {
                ...
                Breadcrumb.Add(_record.Title.ToString(), Developer.ConstantUrl("content") + "?dhx=edit&id=" + CatID + "&catid=" + _record.CatID.ToString() + "&ptype=" + PageTypeID);
            }
            #endregion
            ...
            if (Request["dhx"] != null)
            {
                if (Request["dhx"].ToString() == "edit")
                {
                    ...
                    Breadcrumb.Add(Title, Developer.ConstantUrl("plans") + "?catid=" + CatID + "&ptype=" + PageTypeID);
